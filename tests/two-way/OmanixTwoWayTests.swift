...
func run() throws {
    ...
    print("\n[3] setWidgetEnabled('store', true) / ('pomodoro', true)")
    ...
    print("\n[4] invalid values rejected by CLI (schema)")
    ...
    print("\n[5] Nix writes state.nix -> Swift readers reflect it")
    let state = """
    { ... }:
    {
    ...
    print("\n[6] unset options fall back to defaults (fresh empty flake dir)")
